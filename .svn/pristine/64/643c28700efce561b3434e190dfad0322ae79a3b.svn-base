...
import com.lenovo.service.activity.OrdertaskActivity;
...
import com.lenovo.service.entity.base.Revoketask;
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        if (flagBtn == holdId) {
            if (!"服务完".equals(orderState)) {
                ...
                firstflag = true;
                mshow = "n";
                //Log.e(TAG,"onBindViewHolder flagBtn firstflag is  我来也");
               //Log.e(TAG,"onBindViewHolder flagBtn firstflag is ("+firstflag+")");
               //Log.e(TAG,"onBindViewHolder mTaskRevoke flagBtn is ("+flagBtn+")");
                //Log.e(TAG,"onBindViewHolder mTaskRevoke position is ("+position+")");
           ...
           // Log.e(TAG,"onBindViewHolder() mTaskRevoke VISIBLE");
            //isshow = 2;
        ...
        pos++;
            ...
            mTaskRevoke.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    //Log.d(TAG,"mTaskRevoke click  soTaskId is ("+soTaskId+")");
