 ...
 */
public class BackPiecesData extends BaseData {
    private ArrayList<PiecesData> list;

    public ArrayList<PiecesData> getList() {
        return list;
    }

    public void setList(ArrayList<PiecesData> list) {
        this.list = list;
    }
