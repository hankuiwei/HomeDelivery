...
import com.lenovo.service.activity.BaseActivity;
import com.lenovo.service.activity.HomeActivity;
import com.lenovo.service.widget.HomeTabItem;
import com.lenovo.service.widget.HomeTabView;
...
public class EServiceFragment extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle
        ...
        if (mViewGroup == null) {
            ...
            mViewPager.setAdapter(new PageAdapter(getFragmentManager()));
            mBottomBar = (com.lenovo.service.widget.HomeTabView) mViewGroup.findViewById(R.id.bottom_bar);
            mBottomBar.setViewPager(mViewPager);
            mAtMeTabItem = (com.lenovo.service.widget.HomeTabItem) mBottomBar.getChildAt(AT_ME_FRAG_POS);
            mRankTabItem = (com.lenovo.service.widget.HomeTabItem) mBottomBar.getChildAt(SPARE_PART_FRAG_POS);
...
//                return;
    ...
    class PageAdapter extends FragmentStatePagerAdapter implements com.lenovo.service.widget.HomeTabView.OnItemIconTextSelectListener {
