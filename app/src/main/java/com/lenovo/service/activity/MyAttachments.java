...
import com.lenovo.service.adapter.LocalAttachAdapter;
import com.lenovo.service.adapter.OrderFragmentAdapter;
import com.lenovo.service.fragment.UnuploadAttachFragment;
import com.lenovo.service.fragment.UploadAttachFragment;
    ...
    private void changeUIStatus(int position) {
        switch (position) {
            case TAB_UNUPLOAD:
                ...
                mUnuploadTab.setBackgroundColor(getResources().getColor(R.color.white));
                ...
                mTxtUploadLine.setBackgroundColor(getResources().getColor(R.color.gray_cccccc));
                mUploadTab.setBackgroundDrawable(getResources().getDrawable(R.drawable.shape_0dpcorner_gray_bg));
                ...
                break;
            case TAB_UPLOAD:
                mTxtUnuploadLine.setBackgroundColor(getResources().getColor(R.color.gray_cccccc));
                mUnuploadTab.setBackgroundDrawable(getResources().getDrawable(R.drawable.shape_0dpcorner_gray_bg));
                ...
                mUploadTab.setBackgroundColor(getResources().getColor(R.color.white));
